    ...
    return (
      <div className="Footer">
        <div className="teaSocietyBanner">
          <video autoplay="true" muted playsinline loop type="video/webm" src="https://cdn.intelligencebank.com/au/share/NOrD/e3oNW/vvAy3/webm/FA+animated+logo_1583847446" />
        ...
        <div className="bCorpBanner">
          <div className="textBox">
            <div className="text">
              Your favourite tea is now B Corp certified. We are now proudly part of a global community of over 3,000 companies doing business that puts people and place first.
            </div>
                  ...
                  return (
                    <li key={el.sns}>
                      <a href={el.href} target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox={el.viewBox}>
                          <title>{el.sns}</title>
