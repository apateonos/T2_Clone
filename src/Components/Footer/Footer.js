    ...
    return (
      <>
        ...
        <div className="bCorpBanner">
          <div className="textBox">
            <div className="text">Your favourite tea is now B Corp certified. We are now proudly part of a global community of over 3,000 companies doing business that puts people and place first.
              </div>
        ...
        <footer>
          ...
          <ul>
            <li><a href="#"><span>Tea Society</span></a></li>
            <li><a href="#"><span>Store Finder</span></a></li>
            <li><a href="#"><span>Gift Cards</span></a></li>
            <li><a href="#"><span>UNiDAYS</span></a></li>
